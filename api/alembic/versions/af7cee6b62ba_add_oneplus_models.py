...
Revision ID: af7cee6b62ba
Revises: b5507670d2d8
Create Date: 2025-02-24 15:15:30.404076
...
revision: str = 'af7cee6b62ba'
down_revision: Union[str, None] = 'b5507670d2d8'
...
def upgrade() -> None:
    ...
    brand_name = 'OnePlus'  # Укажи здесь нужное название бренда вручную
    conn = op.get_bind()
...
def downgrade():
    ...
    op.execute("DELETE FROM device_models WHERE device_brand_id = (SELECT id FROM device_brands WHERE name = 'OnePlus')")
